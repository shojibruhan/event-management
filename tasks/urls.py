from tasks.views import search_event, managerdashboard, view_participents, participent_dashboard, dashboard, create_events, delete_event, update_event, event_details, dashboard
